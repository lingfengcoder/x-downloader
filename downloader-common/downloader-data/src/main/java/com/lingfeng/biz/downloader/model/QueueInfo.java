...
public class QueueInfo {
    ...
    public boolean equals(Object o) {
        ...
        return fetchCount == queueInfo.fetchCount &&
                queueLen == queueInfo.queueLen &&
                remainCount == queueInfo.remainCount &&
                retryCount == queueInfo.retryCount &&
                Objects.equals(exchange, queueInfo.exchange) &&
                Objects.equals(queue, queueInfo.queue) &&
                Objects.equals(routeKey, queueInfo.routeKey) &&
                Objects.equals(type, queueInfo.type);
    }
