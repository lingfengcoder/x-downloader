 ...
 */
package com.lingfeng.biz.downloader.it.sauronsoftware.jave;
...
public class DefaultFFMPEGLocator extends FFMPEGLocator {
    ...
    private static final String FFMEPG_HOME = "/data/ffmpeg/";

    {
        System.setProperty("ffmpeg.home", FFMEPG_HOME);
    }
    ...
    private void copyFile(String path, File dest) throws RuntimeException {
        log.info("ffmpef copyFile path{}", path);
