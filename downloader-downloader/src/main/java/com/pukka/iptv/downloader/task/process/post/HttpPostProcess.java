...
import com.pukka.iptv.downloader.enums.FileType;
...
import com.pukka.iptv.downloader.util.MediaParser;
 ...
 * @Description: HTTP下载成功处理器
 */
@Component
@Slf4j
public class HttpPostProcess extends AbsolutePostProcess {
